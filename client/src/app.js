...
export class App {
  configureRouter(config, router){
    ...
    config.map([
      ...
      { route: 'login', moduleId: './Login/login', nav: true, title:'Login',  auth: false, name:'login' },
      { route: 'newuser',   moduleId: './Login/new-user',     nav: false, title:'New User', name:'newuser',  auth: false }
